...
#ifdef _DEBUG
	static int WriteLog(string &strLog, enLogInfoLevel enLevel = ENUM_LOG_LEVEL_DEBUG, bool bForce = false);
    static int WriteLog(TCHAR* pstrLog,  enLogInfoLevel enLevel = ENUM_LOG_LEVEL_DEBUG, bool bForce = false);
    //static int WriteLog(char* pszLog, enLogInfoLevel enLevel = ENUM_LOG_LEVEL_DEBUG, bool bForce = false);
#else
    static int WriteLog(string &strLog, enLogInfoLevel enLevel = ENUM_LOG_LEVEL_RUN, bool bForce = false);
	static int WriteLog(TCHAR* pstrLog,  enLogInfoLevel enLevel = ENUM_LOG_LEVEL_RUN, bool bForce = false);
    //static int WriteLog(char* pszLog, enLogInfoLevel enLevel = ENUM_LOG_LEVEL_DEBUG, bool bForce = false);
#endif
};
