/****************************************************************************
** Meta object code from reading C++ file 'algorithmtester.h'
**
...
#error "The header file 'algorithmtester.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_AlgorithmTester_t, stringdata) + ofs \
...
const QMetaObject AlgorithmTester::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_AlgorithmTester.data,
      qt_meta_data_AlgorithmTester,  qt_static_metacall, 0, 0}
};
